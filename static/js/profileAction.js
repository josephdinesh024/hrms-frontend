                        ...
                        <div class="grid grid-cols-2 py-3 gap-6 items-start">
                            ...
                            <div class="w-3/4">
                                ...
                                <div id="file_image" class="text-textPrimary cursor-pointer" onclick="FilePreviewURL('${item.file_path}')">
                                    ${item?.file_path ? ["jpg", "jpeg", "png"].includes(item.file_path.split("/").pop().split(".").pop()) ? `
                                    <img src="${await FilePreviewURL(item.file_path, false)}" alt="certificate"
                                        class="w-20 h-20">`
                    ...
                    `<div class="border-b-2 w-3/4">
                            ...
                            <div class="w-3/4">
                                ...
                                <div id="file_image" class="text-textPrimary cursor-pointer" onclick="FilePreviewURL('${item.file.file_path}')">
                                    ${item?.file?.file_path ? ["jpg", "jpeg", "png"].includes(item.file.file_path.split("/").pop().split(".").pop()) ? `
                                    <img src="${await FilePreviewURL(item.file.file_path, false)}" alt="education"
                                        class="w-20 h-20">`
                    : `<span class="text-sm text-blue-400 cursor-pointer">Preview</span>`
                    : `
...
async function docsDataExtraction(obj, parentSection,checking = false) {
    ...
    result += `${!checking ? `<div class="grid grid-cols-1 gap-6 items-start" id="terms_condition">
                                ...
                                ${termsURL?.file_path ? ["jpg", "jpeg", "png"].includes(termsURL?.file_path.split("/").pop().split(".").pop()) ? `
                                    <img src="${await FilePreviewURL(termsURL?.file_path, false)}" alt="terms"
